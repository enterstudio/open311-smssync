...
exports.onSend = function (done) {
  ...
  console.log('request sms to send', new Date());
...
exports.onQueued = function (done) {
  ...
  console.log('waiting delivery report', new Date());
  ...
  async.waterfall([
    ...
    function returnUuidsOfQueuedMessages(messages, next) {
      ...
      console.log('waiting delivery report', uuids);
...
exports.onDelivered = function (delivered, done) {
  ...
  console.log('delivered', new Date());
